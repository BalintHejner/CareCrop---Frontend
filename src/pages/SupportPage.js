...
const FeedbackSection = () => (
  ...
  <img loading="lazy" src={require('../images/carecroplogo.png')} className="  sitecarecroplogo  " />
    ...
    <div className="flex gap-2.5 self-start px-2 py-3 mb-4 mt-3  text-2xl rounded border border-solid border-[color:var(--Gray,#A6A6A6)] text-neutral-400 max-md:flex-wrap max-md:max-w-full">
      ...
      <Button2 text={"Küldés"} className={"text-2xl self-end w-btn2 px-16 py-4 mt-8 max-w-full font-bold text-black bg-orange-200 rounded-xl border-black border-solid shadow-sm border-[3px]"}/>
    </div>
