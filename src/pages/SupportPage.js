...
const FeedbackSection = () => (
  ...
  <img loading="lazy" src={require('../images/carecroplogo.png')} className="  sitecarecroplogo  " />
    ...
    <div className=" ml-1 flex gap-2.5 self-start px-2 py-3 mb-4 text-2xl bg-white rounded border border-solid border-[color:var(--Gray,#A6A6A6)] text-neutral-400 max-md:flex-wrap max-md:max-w-full">
