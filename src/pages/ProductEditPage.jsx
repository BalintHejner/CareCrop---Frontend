...
const EditSection = ({imageurl}) => (
  <section className=" w-full max-w-[1624px] max-md:mt-10 max-md:max-w-full my-auto gap-5 text-black whitespace-nowrap bg-body leading-[100%]">
    <div className="flex gap-5 md:flex-col md:gap-0">
      <div className="flex flex-col mt-3 items-center ml-5 w-[72%] max-md:ml-0 max-md:w-full" style={{marginLeft : "auto", marginRight: "auto"}}>
        <div className="flex flex-col grow items-center px-5 max-md:mt-10 max-md:max-w-full">
          <Grid container spacing={10}>
            <Grid item xs={8} sm={6} md={6} lg={4} xl={4}>
                ...
                <FileUpload id="fileupload" itemTemplate={imageurl} name="fileupload" maxFileSize={1000000} mode='basic' url={'/api/upload'} multiple={false} accept="image/*" className='text-2xl w-225rem px-3 py-4 mt-2 max-w-full font-bold leading-6 text-black whitespace-nowrap bg-orange-200 rounded-xl border-black border-solid shadow-sm border-[3px]' />
            </Grid> 
            <Grid item xs={8} sm={6} md={6} lg={4} xl={4}>
            <div className="flex flex-col mt-1 bg-white w-225rem  rounded border border-solid shadow-sm border-zinc-300">
                  <select className="shadow appearance-none w-225rem border rounded h-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <input className='shadow appearance-none border mt-3 rounded w-225rem h-input py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' type="text" placeholder="*Mennyiség (kg)  " /> 

                <div className="flex flex-col mt-1 w-225rem bg-white rounded border border-solid shadow-sm border-zinc-300">
                  <select className="shadow appearance-none w-225rem border rounded h-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            ...
            <Grid item xs={8} sm={6} md={6} lg={4} xl={4}>
              <Input type="number" placeholder="*Ár (Ft)" />
              <div className="flex flex-col mt-1 w-225rem bg-white rounded border border-solid shadow-sm border-zinc-300">
                  <InputTextarea placeholder={"Leírás"} rows={7} style={{width: "360px"}} cols={50}  className="w-225rem py-3 px-3 flex gap-5 justify-between items-start pt-1.5 pr-1.5 pb-12 pl-4 text-base leading-6 text-gray-700 bg-white rounded border border-solid border-[color:var(--denim-16-center-channel-text,rgba(63,67,80,0.16))] h-15 max-md:flex-wrap max-md:max-w-full focus:outline-none focus:shadow-outline focus:border-blue-500" />
              </div>
