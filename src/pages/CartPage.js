...
const ProductInfo = ({crop, amount, price, payment}) => (
  ...
  <div className="flex flex-col mt-8 text-base aspect-square text-black bg-brown md:mt-10 md:max-w-full">
      ...
      <section className="self-center mt-16 w-full max-w-[1728px] md:mt-10 md:max-w-full">
        <div className="flex gap-5 md:flex-col">
          <aside className="flex flex-col w-[33%] md:ml-0 md:w-full">
            ...
            <Button2 text={"Fizetés"} className={"text-2xl justify-center items-center w-btn2 px-16 py-4 mt-8 max-w-full font-bold leading-6 text-black whitespace-nowrap bg-orange-200 rounded-xl border-black border-solid shadow-sm border-[3px]"} />
            </div>
          </aside>
          <ProductInfo />
        </div>
