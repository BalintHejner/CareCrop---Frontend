  ...
  return (
    ...
    <div className="word-wrap self-center text-4xl italic font-light leading-9 items-center text-black" >
      Visszajelzése van? Ossza meg velünk!
    </div>
      
    <Grid container spacing={2}>
      <Grid item xs={10} sm={12} md={7} lg={9} xl={4}>
    ...
    <Grid container>
      <Grid item xs={10} sm={10} md={10} lg={12} xl={4}>
