...
const ProductCard = ({ imgSrc, title, quantity, price, seller }) => {
  imgSrc = imgSrc === "" ? require("../images/placeholder.png") : require("../images/carecroplogo.png");
...
const UserSection = () => {
  const { name, email, phone } = useContext(Context);
            ...
            <Grid container style={{ marginLeft: "auto", marginRight: "auto" }}>
              ...
              <Grid item xs={12} sm={12} md={8} lg={9} xl={9}>
                ...
                <div className="items-center w-full max-md:mt-10 max-md:max-w-full">
                  <ProductCard imgSrc={""} title={"Repce"} quantity={"100"} price={"10000"} seller={"Sándor"} />
                  <ProductCard imgSrc={""} title={"Borsó"} quantity={"100"} price={"10000"} seller={"Sándor"} />
                </div>
              </Grid>
            </Grid>
          </div>
...
function ProfilePage() {
  return (
    <main className="flex flex-col min-h-lg items-center pb-2 bg-body">
      <Header />
      <div className="text-3xl font-bold mt-11">Sándor fiókja</div>
