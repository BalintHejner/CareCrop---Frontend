...
export default function Header2() {
    return (
      ...
      <div className="flex  justify-between self-stretch px-6 py-2 w-full text-2xl bg-header max-md:flex-wrap max-md:pr-5 max-md:max-w-full">
        ...
        <select className="shadow appearance-none border rounded  w-360 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
          <option value="" disabled selected>Válasszon árucsoportot</option>
          <option value="Termény">Termény</option>
          ...
          <div className="flex gap-5 justify-between my-auto max-md:flex-wrap max-md:max-w-full">
            ...
            <img loading="lazy" src={require('../images/shopping-cart.png')} className="cart"/>
